...
`)}{display: none !important;}`)},addBlockCSSWithEnd(...e){let t=T.addBlockCSS(...e);t&&document.documentElement.appendChild(t)},setGMResourceCSS(e){let t=typeof m==`function`?m(e.keyName):null;return typeof t==`string`&&t?K(t):T.loadStyleLink(e.url)},async loadStyleLink(t){let n=document.createElement(`link`);return n.rel=`stylesheet`,n.type=`text/css`,n.href=t,new Promise(t=>{e.default.onReady(()=>{document.head.appendChild(n),t(n)})})},async loadScript(e){let t=document.createElement(`script`);return t.src=e,new Promise(e=>{t.onload=()=>{e(null)},(document.head||document.documentElement).appendChild(t)})},fixUrl(e){return e=e.trim(),e.startsWith(`data:`)||e.match(/^http(s|):\/\//i)?e:e.startsWith(`//`)?(e.startsWith(`///`)||(e=window.location.protocol+e),e):(e.startsWith(`/`)||(e+=`/`),e=window.location.origin+e,e)},fixHttps(e){if(e.startsWith(`https://`)||!e.startsWith(`http://`))return e;try{let t=new URL(e);return t.protocol=`https:`,t.toString()}catch{return e}},lockScroll(...e){let t=document.createElement(`style`);t.innerHTML=`
		...
		`;let n=[document.documentElement,document.body].concat(...e||[]);return n.forEach(e=>{e.classList.add(`pops-overflow-hidden-important`)}),(document.head||document.documentElement).appendChild(t),{recovery(){n.forEach(e=>{e.classList.remove(`pops-overflow-hidden-important`)}),t.remove()}}},async getClipboardText(){function e(e){navigator.clipboard.readText().then(t=>{e(t)}).catch(t=>{H.error(`读取剪贴板内容失败👉`,t),e(``)})}function t(t){navigator.permissions.query({name:`clipboard-read`}).then(()=>{e(t)}).catch(n=>{H.error(`申请剪贴板权限失败，尝试直接读取👉`,n.message??n.name??n.stack),e(t)})}function n(){return!(typeof navigator?.clipboard?.readText!=`function`||typeof navigator?.permissions?.query!=`function`)}return new Promise(e=>{if(!n()){e(``);return}document.hasFocus()?t(e):window.addEventListener(`focus`,()=>{t(e)},{once:!0})})},escapeHtml(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`).replace(/©/g,`&copy;`).replace(/®/g,`&reg;`).replace(/™/g,`&trade;`).replace(/→/g,`&rarr;`).replace(/←/g,`&larr;`).replace(/↑/g,`&uarr;`).replace(/↓/g,`&darr;`).replace(/—/g,`&mdash;`).replace(/–/g,`&ndash;`).replace(/…/g,`&hellip;`).replace(/ /g,`&nbsp;`).replace(/\r\n/g,`<br>`).replace(/\r/g,`<br>`).replace(/\n/g,`<br>`).replace(/\t/g,`&nbsp;&nbsp;&nbsp;&nbsp;`)},interval(e,t,n=5e3){let r,i=n-t,a=t,o=async n=>{let s=await e(n);if(typeof s==`boolean`&&s||n){z.workerClearTimeout(r);return}if(a+=t,a>i){o(!0);return}r=z.workerSetTimeout(()=>{o(!1)},t)};o(!1)},findParentNode(t,n,r){if(r){let i=e.default.closest(t,r);if(i)return i.querySelector(n)}else return e.default.matches(t,n)?t:e.default.closest(t,n)},toStr(e,t=2){let n=`__undefined__placeholder__replaced__str__`+performance.now();return JSON.stringify(e,(e,t)=>t===void 0?n:t,t).replace(RegExp(`"${n}"`,`g`),`undefined`)},isVerticalScreen(){return!globalThis.screen.orientation.type.includes(`landscape`)},isMobileDevice(e=768){return this.isVerticalScreen()?globalThis.innerWidth<e:globalThis.innerHeight<e},isTopWindow(){let e=typeof b==`object`&&b?b:window;return e.top===e.self},formatVideoDuration(e){if(typeof e!=`number`&&(e=parseInt(e)),isNaN(e))return e.toString();let t=function(e){return e<10?`0${e}`:e};if(e<60)return`0:${t(e)}`;if(e>=60&&e<3600)return`${Math.floor(e/60)}:${t(e%60)}`;{let n=Math.floor(e/3600),r=Math.floor(e/60)%60,i=e%60;return`${n}:${t(r)}:${t(i)}`}},formatTimeStamp(e,t){if(typeof e==`number`&&e<0xe8d4a51000){let t=String(Date.now()).length-String(e).length;e*=10**t}let n=e,r=new Date(typeof e==`string`?e.replace(/-/g,`/`):e),i=new Date(t??Date.now()).getTime()-r.getTime(),a=Math.floor(i/(24*3600*1e3));if(a>0)n=a>7?z.formatTime(r.getTime()):a+`天前`;else{let e=i%(24*3600*1e3),t=Math.floor(e/(3600*1e3));if(t>0)n=t+`小时前`;else{let t=e%(3600*1e3),r=Math.floor(t/(60*1e3));if(r>0)n=r+`分钟前`;else{let e=t%(60*1e3);n=Math.round(e/1e3)+`秒前`}}}return n}},E=`GM_Panel`,ie=`data-init`,D=`data-key`,O=`data-default-value`,k=`data-init-more-value`,A=`data-plugin-search-config`,j=`data-storage-api`,M={followBrowserSize:!1,get width(){return M.followBrowserSize?globalThis.outerWidth:globalThis.innerWidth},get height(){return M.followBrowserSize?globalThis.outerHeight:globalThis.innerHeight}},N={setting:{get width(){return M.width<550?`88vw`:M.width<700?`550px`:`700px`},get height(){return M.height<450?`70vh`:M.height<550?`450px`:`550px`}},settingMiddle:{get width(){return M.width<350?`88vw`:`350px`},get height(){return M.height<450?`88vh`:`450px`}},settingBig:{get width(){return M.width<800?`92vw`:`800px`},get height(){return M.height<600?`80vh`:`600px`}},info:{get width(){return M.width<350?`88vw`:`350px`},get height(){return M.height<250?`88vh`:`250px`}}},P={$data:{__contentConfig:null,get contentConfig(){return this.__contentConfig??=new z.Dictionary,this.__contentConfig},__defaultBottomContentConfig:[]},addContentConfig(e){Array.isArray(e)||(e=[e]);let t=this.$data.contentConfig.keys().length;this.$data.contentConfig.set(t,e)},getAllContentConfig(){return this.$data.contentConfig.values().flat()},getConfig(e=0){return this.$data.contentConfig.get(e)??[]},getDefaultBottomContentConfig(e){if(this.$data.__defaultBottomContentConfig.length)return this.$data.__defaultBottomContentConfig;let t=!1,n,i=(t,n)=>{if(e&&typeof e.translateCallback==`function`)return e.translateCallback(t,n);if(typeof n==`object`&&n)for(let e in n)t=t.replaceAll(`{{${e}}}`,n[e]);return t},a=(e,t)=>{typeof t!=`string`&&(t=T.toStr(t));let n=new Blob([t]),r=globalThis.URL.createObjectURL(n);B.createElement(`a`,{href:r,download:e}).click(),z.workerSetTimeout(()=>{globalThis.URL.revokeObjectURL(r)},500)},o=()=>{let e=e=>{let t=V.alert({title:{text:i(`请选择导入方式`),position:`center`},content:{text:`
          ...
          .btn-control:hover{
          ...
          }`}),n=t.$shadowRoot.querySelector(`.btn-control[data-mode='local']`),a=t.$shadowRoot.querySelector(`.btn-control[data-mode='network']`),o=t.$shadowRoot.querySelector(`.btn-control[data-mode='clipboard']`),s=async t=>{confirm(i(`是否清空脚本存储的配置？（如果点击取消按钮，则仅做配置覆盖处理）`))&&(typeof _==`function`?typeof p==`function`?(_().forEach(e=>{p(e)}),r.default.success(i(`已清空脚本存储的配置`))):r.default.error(i(`不支持GM_deleteValue函数，无法执行删除脚本配置`)):r.default.error(i(`不支持GM_listValues函数，无法清空脚本存储的配置`))),typeof y==`function`?y(t):Object.keys(t).forEach(e=>{let n=t[e];v(e,n)}),r.default.success(i(`配置导入完毕`)),e?.()},c=e=>new Promise(async t=>{let n=z.toJSON(e);Object.keys(n).length===0?r.default.warning(i(`解析为空配置，不导入`)):await s(n),t(!0)});B.on(n,`click`,e=>{B.preventEvent(e),t.close();let n=B.createElement(`input`,{type:`file`,accept:`.json`});B.on(n,[`propertychange`,`input`],()=>{if(!n.files?.length)return;let e=n.files[0],t=new FileReader;t.onload=()=>{c(t.result)},t.readAsText(e,`UTF-8`)}),n.click()}),B.on(a,`click`,e=>{B.preventEvent(e),t.close();let n=V.prompt({title:{text:i(`网络导入`),position:`center`},content:{text:``,placeholder:i(`请填写URL`),focus:!0},btn:{close:{enable:!0,callback(e){e.close()}},ok:{text:i(`导入`),callback:async e=>{let t=e.text;if(z.isNull(t)){r.default.error(i(`请填入完整的url`));return}let n=r.default.loading(i(`正在获取配置...`)),a=await G.get(t,{allowInterceptConfig:!1});if(n.close(),!a.status){H.error(a),r.default.error(i(`获取配置失败`),{consoleLogContent:!0});return}await c(a.data.responseText)&&e.close()}},cancel:{enable:!1}},drag:!0,mask:{enable:!0},width:N.info.width,height:`auto`}),a=n.$shadowRoot.querySelector(`input`),o=n.$shadowRoot.querySelector(`.pops-prompt-btn-ok`);B.on(a,[`input`,`propertychange`],()=>{B.val(a)===``?B.attr(o,`disabled`,`true`):B.removeAttr(o,`disabled`)}),B.onKeyboard(a,`keydown`,(e,t,n)=>{e===`Enter`&&n.length===0&&B.val(a)!==``&&B.emit(o,`click`)}),B.emit(a,`input`)}),B.on(o,`click`,async e=>{B.preventEvent(e),t.close();let n=await T.getClipboardText();if(n.trim()===``){r.default.warning(i(`获取到的剪贴板内容为空`));return}await c(n)})},t=(e=`${U}_panel-setting-${z.formatTime(Date.now(),`yyyy_MM_dd_HH_mm_ss`)}.json`,t)=>{let n=V.alert({title:{text:i(`请选择导出方式`),position:`center`},content:{text:`
            ...
            `,html:!0},btn:{ok:{enable:!1},close:{enable:!0,callback(e){e.close()}}},drag:!0,mask:{enable:!0},width:N.info.width,height:N.info.height,style:`
          .btn-control{
            display: inline-block;
            margin: 10px;
            padding: 10px;
          ...
          .btn-control:hover{
            ...
            border-color: #c6e2ff;
            background-color: #ecf5ff;
          }`}),o=n.$shadowRoot.querySelector(`.btn-control[data-mode='export-to-file']`),s=n.$shadowRoot.querySelector(`.btn-control[data-mode='export-to-clipboard']`);B.on(o,`click`,i=>{B.preventEvent(i);try{a(e,t),n.close()}catch(e){r.default.error(e.toString(),{consoleLogContent:!0})}}),B.on(s,`click`,async()=>{await z.copy(t)?(r.default.success(i(`复制成功`)),n.close()):r.default.error(i(`复制失败`))})},n=V.confirm({title:{text:i(`配置`),position:`center`},content:{text:`<textarea name="config-value" id="config" readonly></textarea>`,html:!0},btn:{ok:{enable:!0,type:`primary`,text:i(`导入`),callback(){e()}},cancel:{enable:!0,text:i(`导出`),callback(){t(void 0,s)}}},width:M.width<450?`90vw`:`450px`,height:`auto`,style:`
      ...
      `,...this.$data.panelConfig});return this.$data.$panel=a,this.$data.panelContent=e,r||this.registerConfigSearch({$panel:a,content:e}),{$panel:a,content:e}},registerConfigSearch(e){let{$panel:t,content:n}=e,i=(t,n)=>{if(typeof e.translateCallback==`function`)return e.translateCallback(t,n);if(typeof n==`object`&&n)for(let e in n)t=t.replaceAll(`{{${e}}}`,n[e]);return t},a=async(e,t)=>{if(e==null)return;let n=await t(e);return n&&typeof n.isFind==`boolean`&&n.isFind?n.data:await a(n.data,t)},o=(e,t)=>{let n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(t?.(),n.disconnect())})},{root:null,threshold:1});n.observe(e),e.scrollIntoView({behavior:`smooth`,block:`center`})},s=e=>{let t=`pops-flashing`;B.onAnimationend(e,()=>{e.classList.remove(t)}),e.classList.add(t)},c=c=>{if(c.type===`dblclick`&&f)return;B.preventEvent(c);let l=V.alert({title:{text:i(`搜索配置`),position:`center`},content:{text:`
						<div class="search-wrapper">
							<input class="search-config-text" name="search-config" type="text" placeholder="${i(`请输入需要搜素的配置名称`)}">
						</div>
						<div class="search-result-wrapper"></div>
					`,html:!0},btn:{ok:{enable:!1}},mask:{clickEvent:{toClose:!0}},width:N.settingMiddle.width,height:`auto`,drag:!0,style:`
            ...
            flex-wrap: wrap;
					...
					${e.searchDialogStyle??``}
				`}),u=l.$shadowRoot.querySelector(`.search-config-text`),d=l.$shadowRoot.querySelector(`.search-result-wrapper`);u.focus();let p=()=>{B.empty(d)},m=e=>{let n=z.queryProperty(e,e=>e?.next?{isFind:!1,data:e.next}:{isFind:!0,data:e}),c=B.createElement(`div`,{className:`search-result-item`,innerHTML:`
						...
						`}),l=V.fn.PanelHandlerComponents();return B.on(c,`click`,()=>{let n=t.$shadowRoot.querySelectorAll(`aside.pops-panel-aside .pops-panel-aside-top-container li`)[e.index];if(!n){r.default.error(i(`左侧项下标{{index}}不存在`,{index:e.index}));return}n.scrollIntoView({behavior:`smooth`,block:`center`}),n.click(),a(e.next,async e=>{if(e?.next){let n=await B.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(`.pops-panel-deepMenu-nav-item`)).find(t=>{let n=Reflect.get(t,l.$data.nodeStoreConfigKey);return typeof n==`object`&&!!n&&n.text===e.name}),2500);if(n)n.click();else return r.default.error(i(`未找到对应的二级菜单`)),{isFind:!0,data:e};return{isFind:!1,data:e.next}}else{let n=await B.waitNode(()=>Array.from(t.$shadowRoot.querySelectorAll(`li:not(.pops-panel-deepMenu-nav-item)`)).find(t=>Reflect.get(t,l.$data.nodeStoreConfigKey)===e.matchedData?.formConfig),2500);if(n){o(n);let e=n.closest(`.pops-panel-forms-fold[data-fold-enable]`);e&&(e.querySelector(`.pops-panel-forms-fold-container`).click(),await z.sleep(500)),o(n,()=>{s(n)})}else r.default.error(i(`未找到对应的菜单项`));return{isFind:!0,data:e}}})}),c},h=e=>{let t=new RegExp(e,`i`),r=[],i=(e,n)=>{for(let a=0;a<e.length;a++){let o=e[a],s=o.views;if(s&&Array.isArray(s)){let e=z.deepClone(n);if(o.type===`deepMenu`){let t=z.queryProperty(e,e=>e?.next?{isFind:!1,data:e.next}:{isFind:!0,data:e});t.next={name:o.text}}i(s,e)}else{let e,i;if(o.type===`own`){let t=Reflect.get(o.attributes||{},A);t&&(typeof t==`function`&&(t=t()),typeof t.text==`string`&&(e=t.text),typeof t.desc==`string`&&(i=t.desc))}else e=o.text,i=Reflect.get(o,`description`);let a=[e,i],s=a.findIndex(e=>{if(typeof e==`string`)return e.match(t)});if(s!==-1){let t=z.deepClone(n),c=z.queryProperty(t,e=>e?.next?{isFind:!1,data:e.next}:{isFind:!0,data:e});c.next={name:e,matchedData:{path:``,formConfig:o,matchedText:a[s],description:i}};let l=[];z.queryProperty(t,e=>{let t=e?.name;return typeof t==`string`&&t.trim()!==``&&l.push(t),e?.next?{isFind:!1,data:e.next}:{isFind:!0,data:e}});let u=l.join(T.escapeHtml(` - `));c.next.matchedData.path=u,r.push(t)}}}};for(let e=0;e<n.length;e++){let t=n[e];if(!t.views||t.isBottom&&t.id===`script-version`)continue;let r=t.views;if(r&&Array.isArray(r)){let n=t.title;typeof n==`function`&&(n=n()),i(r,{index:e,name:n})}}let a=document.createDocumentFragment();for(let e of r){let t=m(e);a.appendChild(t)}p(),d.append(a)};B.on(u,`input`,z.debounce(e=>{B.preventEvent(e);let t=B.val(u).trim();if(t===``){p();return}h(t)},200))};t.$shadowRoot.querySelectorAll(`aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)`).forEach(e=>{B.on(e,`dblclick`,c)});let l=new WeakMap,u=!1,d,f=!1;B.on(t.$shadowRoot,`touchend`,`aside.pops-panel-aside .pops-panel-aside-item:not(#script-version)`,(e,t)=>{f=!0,clearTimeout(d),d=void 0,u&&l.has(t)?(u=!1,l.delete(t),c(e)):(d=setTimeout(()=>{u=!1},200),u=!0,l.set(t,e))},{capture:!0}),t.$shadowRoot.appendChild(B.createElement(`style`,{type:`text/css`,textContent:`
    			.pops-flashing{
    		...
    		`}))},transformKey(e){if(Array.isArray(e))if(e.length>1){let t=e.sort();return JSON.stringify(t)}else return e[0];else return e},getDynamicValue(e,t){let n=!1,r=t,i=this.addValueChangeListener(e,(e,t)=>{r=t});return{get value(){return n||(n=!0,r=L.getValue(e,t)),r},destory(){L.removeValueChangeListener(i)}}}},R={qmsg_config_position:{key:`qmsg-config-position`,defaultValue:`bottom`},qmsg_config_maxnums:{key:`qmsg-config-maxnums`,defaultValue:3},qmsg_config_showreverse:{key:`qmsg-config-showreverse`,defaultValue:!1},httpx_cookie_manager_enable:{key:`httpx-use-cookie-enable`,defaultValue:!1},httpx_cookie_manager_use_document_cookie:{key:`httpx-use-document-cookie`,defaultValue:!1}},z=n.default.noConflict(),B=e.default.noConflict(),V=t.default,H=new z.Log(g,b.console||x.console),U=g?.script?.name||void 0,oe=t.default.fn.Utils.AnyTouch();H.config({debug:!1,logMaxCount:250,autoClearConsole:!0,tag:!0});var W=()=>{let e=t.default.fn.InstanceUtils.getPopsMaxZIndex()?.zIndex??0,n=z.getMaxZIndexNodeInfoFromPoint()[0]?.zIndex??0;return Math.max(100,e,n)};r.default.config({isHTML:!0,autoClose:!0,showClose:!1,consoleLogContent(e){let t=e.setting.type;if(t===`loading`)return!1;let n=e.setting.content;return t===`warning`?H.warn(n):t===`error`?H.error(n):H.info(n),!1},get position(){return L.getValue(R.qmsg_config_position.key,R.qmsg_config_position.defaultValue)},get maxNums(){return L.getValue(R.qmsg_config_maxnums.key,R.qmsg_config_maxnums.defaultValue)},get showReverse(){return L.getValue(R.qmsg_config_showreverse.key,R.qmsg_config_showreverse.defaultValue)},get zIndex(){return W()}}),V.GlobalConfig.setGlobalConfig({zIndex:()=>W(),mask:{enable:!0,clickEvent:{toClose:!1,toHide:!1}},drag:!0});var se=new z.GM_Menu({GM_getValue:h,GM_setValue:v,GM_registerMenuCommand:ee,GM_unregisterMenuCommand:ne}),G=new z.Httpx({xmlHttpRequest:re,logDetails:!1});G.interceptors.request.use(e=>e),G.interceptors.response.use(e=>e,e=>(H.error(`[Httpx-HttpxRequest.response] 响应错误`,{data:e}),e.type===`onabort`?r.default.warning(`请求取消`,{consoleLogContent:!0}):e.type===`onerror`?r.default.error(`请求异常`,{consoleLogContent:!0}):e.type===`ontimeout`?r.default.error(`请求超时`,{consoleLogContent:!0}):r.default.error(`其它错误`,{consoleLogContent:!0}),e)),b.Object.defineProperty,b.Object.keys,b.Object.values,b.Function.prototype.apply,b.Function.prototype.call,b.Element.prototype.appendChild,b.setTimeout.bind(b),b.clearTimeout.bind(b),b.setInterval.bind(b),b.clearInterval.bind(b);var K=B.addStyle.bind(B),q=e=>{let t=K(e);return document.documentElement.appendChild(t),t},J=T.addBlockCSS.bind(T),Y=T.addBlockCSSWithEnd.bind(T);e.default.selector.bind(e.default);var ce=e.default.selectorAll.bind(e.default),X=new z.CookieManagerService({baseCookieHandler:`GM_cookie`});X.isSupportGM_cookie||(X.isSupportCookieStore?X.setOptions({baseCookieHandler:`cookieStore`}):X.setOptions({baseCookieHandler:`document.cookie`})),new z.DocumentCookieHandler;var le={init(){L.execMenuOnce([`baidu-search-optimizationResult-enable`,`baidu-search-optimizationResult-removeAds`,`baidu-search-optimizationResult-redirect`],e=>{let[t,n,r]=e.value;if(t&&!(!n&&!r))return this.searchResultShowOptimization({removeAds:n,redirect:r})})},searchResultShowOptimization(e){H.info(`搜索结果优化`,e);let t=new z.LockFunction(()=>{let t=ce(`#content_left > div:not([data-direct-link])`);for(let n of t){if(e.removeAds&&B.selector(`.se_st_footer:contains("广告")`,n)){n.remove();continue}let t=n.getAttribute(`mu`);if(!t)continue;let r=n.querySelector(`a.sc-link[href]`)||n.querySelector(`.c-title a[href]`)||n.querySelector(`a.cosc-title-a[href]`);r&&e.redirect&&(r.href=t,n.setAttribute(`data-direct-link`,`true`))}}),n=z.mutationObserver(document,{config:{subtree:!0,childList:!0,attributes:!0},immediate:!0,callback:()=>{t.run()}});return[()=>{n.disconnect()},e.removeAds?Y(`#content_left > div:has(.ec-tuiguang)`,`#content_left > div:has(.c-recomm-wrap)`):null]}},ue={init(){L.execMenuOnce(`baidu-search-removeRightPanel`,()=>this.removeRightPanel()),L.execMenuOnce(`baidu-search-removeEveryOneSearch`,()=>this.removeEveryOneSearch()),L.execMenuOnce(`baidu-search-removeRelatedSearch`,()=>this.removeRelatedSearch()),L.execMenuOnce([`baidu-search-showOptimization-enable`,`baidu-search-showOptimization-mode`],e=>{let[t,n]=e.value;if(t&&!z.isNull(n))return this.searchResultShowOptimization(n)}),le.init()},removeRightPanel(){return H.info(`移除右侧栏`),Y(`#content_right`)},removeEveryOneSearch(){return H.info(`移除大家都在搜`),Y(`.result-op[tpl="recommend_list"]`)},removeRelatedSearch(){return H.info(`移除相关搜索`),Y(`.result-molecule:has(#rs_new)`)},searchResultShowOptimization(e){H.info(`搜索结果显示优化: `+e);let t=[q(`
      /* AI回答结果变成滚动条形式 */
    ...
    `)),e===`single-center`?t.push(q(n),q(`
        #container #content_left > .c-container {
            width: 55%;
            justify-self: center;
        }
      `)):e===`double-column-center`?t.push(q(r),q(n)):e===`three-column-center`?t.push(q(r),q(n),q(`
        #container #content_left{
          grid-template-columns: repeat(3, 33.3%);
          grid-template-areas: "xmain xmain xmain";
        }
      `)):e===`four-column-center`?t.push(q(r),q(n),q(`
        #container #content_left{
          grid-template-columns: repeat(4, 25%);
          grid-template-areas: "xmain xmain xmain xmain";
        }
      `)):H.error(`不支持的搜索结果显示模式: `+e),t}},de={init(){}},fe={init(){L.execMenuOnce(`google-search-removeRightPanel`,()=>this.removeRightPanel()),L.execMenuOnce(`google-search-removeRelatedSearch`,()=>this.removeRelatedSearch()),L.execMenuOnce(`google-search-removeQuestions`,()=>this.removeQuestions()),L.execMenuOnce([`google-search-showOptimization-enable`,`google-search-showOptimization-mode`],e=>{let[t,n]=e.value;if(t&&!z.isNull(n))return this.searchResultShowOptimization(n)}),de.init()},removeRightPanel(){return H.info(`移除右侧栏`),[J(`#rhs`)]},removeRelatedSearch(){return H.info(`移除用户还搜索了`),J(`#botstuff`)},removeQuestions(){return H.info(`移除相关问题`),J(`#rso > div:not(:empty) > div:has(.related-question-pair)`)},searchResultShowOptimization(e){H.info(`搜索结果显示优化: `+e);let t=[J(`.kp-wholepage-osrp`)],n=`
      #rso:not(:has(>script)),
    ...
    `)),e===`single-center`?t.push(K(`
        #rso{
            width: 55%;
            justify-self: center;
        }
      `)):e===`double-column-center`?t.push(K(n)):e===`three-column-center`?t.push(K(n),K(`
        #rso:not(:has(>script)),
        #rso:has(>script)>div:not(:empty){
            grid-template-columns: repeat(3, 33.3%);
            grid-template-areas: "xmain xmain xmain";
        }
      `)):e===`four-column-center`?t.push(K(n),K(`
        #rso:not(:has(>script)),
        #rso:has(>script)>div:not(:empty){
          grid-template-columns: repeat(4, 25%);
          grid-template-areas: "xmain xmain xmain xmain";
        }
      `)):H.error(`不支持的搜索结果显示模式: `+e),t}},pe={init(){w.isBaiduSearch()?ue.init():w.isGoogleSearch()&&fe.init()}},Z=function(e,t,n=!1,i,a,o,s,c,l){if(l&&typeof l.defaultValue==`object`&&l.defaultValue!=null){let n=l.key??t;l.handler.add({key:n,name:e}),l.handler.shortCut.initConfig(n,l.defaultValue)}let u={text:e,type:`switch`,description:a,disabled:s,attributes:{},props:{},getValue(){return this.props[j].get(t,n)},callback(n,r){let a=!!r;H.success(`${a?`开启`:`关闭`} ${e}`),!(typeof i==`function`&&i(n,a))&&(this.props[j].set(t,a),typeof c==`function`&&c(n,a))},afterAddToUListCallBack:(...n)=>{if(o?.(...n),l){let i=l.handler.shortCut,a=l.key??t,[o,s]=n,c=s.target?.querySelector(`.pops-panel-item-left-main-text`);if(!c)return;let u=()=>{let t=l.handler.shortCut.getShowText(a,`暂未录入快捷键`),n=B.createElement(`div`,{className:`pops-switch-shortcut-wrapper`,innerHTML:`
            ...
            `},{style:`margin-right: 5px;display: inline-flex;`}),r=n.querySelector(`.pops-bottom-icon`);B.on(r,`click`,function(e){l.handler.shortCut.deleteOption(a),i.toolTip.offEvent(),i.toolTip.close(),i.toolTip.destory(),n.remove()},{once:!0});let i=V.tooltip({$target:r,content:()=>t,className:`github-tooltip`,isFixed:!0,only:!0});B.empty(c),B.append(c,n,e)};if(V.rightClickMenu({$target:c,only:!0,data:[{text:()=>l.handler.shortCut.hasOption(a)?`修改快捷键`:`添加快捷键`,icon:V.config.iconSVG.keyboard,callback(e,t,n,o){if(i.isWaitKeyboardPress()){r.default.warning(`请先执行当前的录入操作`);return}let s=r.default.loading(`请按下快捷键...`,{showClose:!0,onClose(){i.cancelEnterShortcutKeys()}});i.enterShortcutKeys(a).then(({status:e,option:t,key:n})=>{s.close(),e?(H.success(`录入快捷键`,t),r.default.success(`录入成功`),u()):r.default.error(`快捷键 ${i.translateKeyboardValueToButtonText(t)} 已被 ${n} 占用`)})}}]}),!i.hasOption(a))return;u()}}};return Reflect.set(u.attributes,D,t),Reflect.set(u.attributes,O,n),Q.initComponentsStorageApi(`switch`,u,{get(e,t){return L.getValue(e,t)},set(e,t){L.setValue(e,t)}}),u},Q={$data:{__storeApiFn:null,get storeApiValue(){return this.__storeApiFn||=new n.default.Dictionary,this.__storeApiFn}},getStorageApi(e){if(this.hasStorageApi(e))return this.$data.storeApiValue.get(e)},hasStorageApi(e){return this.$data.storeApiValue.has(e)},setStorageApi(e,t){this.$data.storeApiValue.set(e,t)},initComponentsStorageApi(e,t,n){let r;r=this.hasStorageApi(e)?this.getStorageApi(e):n,this.setComponentsStorageApiProperty(t,r)},setComponentsStorageApiProperty(e,t){Reflect.set(e.props,j,t)}},$=function(e,t,n,r,i,a,o){let s={text:e,type:`select`,description:a,attributes:{},props:{},getValue(){return this.props[j].get(t,n)},callback(e){if(e==null)return;let n=e.value;H.info(`选择：${e.text}`),!(typeof i==`function`&&i(e))&&(this.props[j].set(t,n),typeof o==`function`&&o(e))},data:r};return Reflect.set(s.attributes,D,t),Reflect.set(s.attributes,O,n),Q.initComponentsStorageApi(`select`,s,{get(e,t){return L.getValue(e,t)},set(e,t){L.setValue(e,t)}}),s},me={id:`view-general`,title:`通用`,views:[{text:`Toast配置`,type:`container`,views:[$(`Toast位置`,R.qmsg_config_position.key,R.qmsg_config_position.defaultValue,[{value:`topleft`,text:`左上角`},{value:`top`,text:`顶部`},{value:`topright`,text:`右上角`},{value:`left`,text:`左边`},{value:`center`,text:`中间`},{value:`right`,text:`右边`},{value:`bottomleft`,text:`左下角`},{value:`bottom`,text:`底部`},{value:`bottomright`,text:`右下角`}],e=>{H.info(`设置当前Qmsg弹出位置`+e.text)},`Toast显示在页面九宫格的位置`),$(`最多显示的数量`,R.qmsg_config_maxnums.key,R.qmsg_config_maxnums.defaultValue,[{value:1,text:`1`},{value:2,text:`2`},{value:3,text:`3`},{value:4,text:`4`},{value:5,text:`5`}],void 0,`限制Toast显示的数量`),Z(`逆序弹出`,R.qmsg_config_showreverse.key,R.qmsg_config_showreverse.defaultValue,void 0,`修改Toast弹出的顺序`)]},{text:`Cookie配置`,type:`container`,views:[Z(`启用`,R.httpx_cookie_manager_enable.key,R.httpx_cookie_manager_enable.defaultValue,void 0,`Api请求时会自动使用下面的Cookie设置`),Z(`使用document.cookie`,R.httpx_cookie_manager_use_document_cookie.key,R.httpx_cookie_manager_use_document_cookie.defaultValue,void 0,`会自动根据请求的域名来使用cookie`)]}]},he={id:`baidu`,title:`百度搜索`,isDefault:w.isBaiduSearch(),views:[{text:`通用`,type:`container`,views:[Z(`移除右侧栏`,`baidu-search-removeRightPanel`,!0),Z(`移除大家都在搜`,`baidu-search-removeEveryOneSearch`,!0),Z(`移除相关搜索`,`baidu-search-removeRelatedSearch`,!0)]},{text:`显示模式优化`,type:`container`,views:[Z(`开启`,`baidu-search-showOptimization-enable`,!0),$(`模式`,`baidu-search-showOptimization-mode`,``,[{text:`无`,value:``},{text:`单列居中`,value:`single-center`},{text:`双列居中`,value:`double-column-center`},{text:`三列居中`,value:`three-column-center`},{text:`四列居中`,value:`four-column-center`}])]},{type:`container`,text:`搜索结果优化`,views:[Z(`开启`,`baidu-search-optimizationResult-enable`,!0),Z(`移除广告`,`baidu-search-optimizationResult-removeAds`,!0),Z(`链接重定向`,`baidu-search-optimizationResult-redirect`,!0)]}]},ge={id:`google`,title:`Google搜索`,isDefault:w.isGoogleSearch(),views:[{text:`通用`,type:`container`,views:[Z(`移除右侧栏`,`google-search-removeRightPanel`,!0),Z(`移除用户还搜索了`,`google-search-removeRelatedSearch`,!0),Z(`移除相关问题`,`google-search-removeQuestions`,!0)]},{text:`显示模式优化`,type:`container`,views:[Z(`开启`,`google-search-showOptimization-enable`,!0),$(`模式`,`google-search-showOptimization-mode`,``,[{text:`无`,value:``},{text:`单列居中`,value:`single-center`},{text:`双列居中`,value:`double-column-center`},{text:`三列居中`,value:`three-column-center`},{text:`四列居中`,value:`four-column-center`}])]}]};P.addContentConfig([me,he,ge]),L.init(),pe.init()})(DOMUtils,pops,Utils,Qmsg);
